...
static std::vector<std::string> s_Preset_print_options {
    "layer_height", "first_layer_height", "angled_slicing_angle", "angled_slicing_direction", "angled_slicing_anchor_line", "angled_slicing_anchor_every_layer", "angled_slicing_anchor_width",
